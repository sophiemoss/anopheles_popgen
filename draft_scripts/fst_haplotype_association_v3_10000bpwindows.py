...
haplotype_clusters = list(window_clusters_with_many_haplotypes.items())
df = pd.DataFrame(haplotype_clusters, columns=['Window', 'Clusters'])
filename = f"haplotype_clusters_{chromosome}.csv"
...
############ These scores don't seem to be correct. There should be more than 5 haplotypes identified to samples, and no windows should have 0 matching haplotypes ######
