...
# %% save tajimad values as text file to be able to access them next time
# Define the file path where you want to save the data
file_path = "tajimad.txt" #saving in current directory

# Save the array as a text file
np.savetxt(file_path, tajimad)

print(f"Saved tajimad array to {file_path}")

# To load the data from the text file into a NumPy array in future
# tajimad = np.loadtxt(file_path)
