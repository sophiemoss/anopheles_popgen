...
#samtools view -b -q 10 AJ0126-C.sorted.bam > AJ0126-C.sorted.filtered.bam

# 3. Create coverage file using samtools depth
#samtools depth -aa AJ0126-C.sorted.filtered.bam > AJ0126-C.sorted.filtered.coverage

# 4. Create sam file from sorted bam,
#samtools view -h AJ0126-C.sorted.filtered.bam -o AJ0126-C.sorted.filtered.sam
